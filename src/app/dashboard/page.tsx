...
function DashboardContent() {
  ...
  async function loadDashboard() {
    ...
    if (profileData.role === 'hr_admin') { router.push('/hr'); return }
  ...
  const cards = [
    ...
    { icon: <span style={{ fontSize: '26px' }}>📊</span>, iconBg: '#f5f3ff', title: 'Analytics', subtitle: 'P&L, breakeven, food cost, daily tracker, compliance trend', href: '/analytics' },
    { icon: <span style={{ fontSize: '26px' }}>📋</span>, iconBg: '#fef3c7', title: 'Reports', subtitle: 'Download Financial, Labour, Stock, Compliance & HR reports — CSV, Excel, PDF', href: '/reports' },
    ...
    { icon: <span style={{ fontSize: '26px' }}>👥</span>, iconBg: '#f0fdf4', title: 'People', subtitle: 'Employee profiles, leave and documents', href: '/people' },
    { icon: <span style={{ fontSize: '26px' }}>🕐</span>, iconBg: '#eff6ff', title: 'Time & Attendance', subtitle: 'Clock in/out, shifts and history', href: '/attendance' },
    { icon: <span style={{ fontSize: '26px' }}>📱</span>, iconBg: '#faf5ff', title: 'Linked Devices', subtitle: 'Link devices and assign roles', href: '/devices' }, 
    { icon: <span style={{ fontSize: '26px' }}>📁</span>, iconBg: '#eff6ff', title: 'Store Documents', subtitle: 'COC, certs, licenses & more', href: '/documents' },
    { icon: <span style={{ fontSize: '26px' }}>💰</span>, iconBg: '#f0fdf4', title: 'Wages & Payroll', subtitle: 'Hours, advances and wage slips', href: '/wages' },
