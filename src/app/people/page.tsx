...
export default function PeoplePage() {
  ...
  async function saveEmployee() {
    ...
    try {
      const payload = { store_id: storeId || '05328298-fc27-4c9f-b091-bb7f6598b601', organisation_id: orgId || 'e903386b-133a-4bad-b054-ef7ef616a3ff', full_name: empForm.full_name.trim(), role: empForm.role, phone: empForm.phone || null, id_number: empForm.id_number || null, start_date: empForm.start_date || null, employment_type: empForm.employment_type, notes: empForm.notes || null, is_active: empForm.is_active };
  ...
  async function saveDocument() {
    ...
    try {
      ...
      await supabase.from('employee_documents').insert({ employee_id: selectedEmployee.id, store_id: storeId || '05328298-fc27-4c9f-b091-bb7f6598b601', document_type: docForm.document_type, document_name: docForm.document_name, file_url: fileUrl, expiry_date: docForm.expiry_date || null, notes: docForm.notes || null });
  ...
  async function saveWarning() {
    ...
    try {
      ...
      await supabase.from('employee_warnings').insert({ employee_id: selectedEmployee.id, store_id: storeId || '05328298-fc27-4c9f-b091-bb7f6598b601', warning_type: warningForm.warning_type, reason: warningForm.reason, incident_date: warningForm.incident_date, issued_by: warningForm.issued_by, document_url: documentUrl, notes: warningForm.notes || null });
  ...
  async function saveAdvance() {
    ...
    setSaving(true); setSaveError(null);
    try {
      await supabase.from('employee_advances').insert({ employee_id: selectedEmployee.id, store_id: storeId || '05328298-fc27-4c9f-b091-bb7f6598b601', amount: parseFloat(advanceForm.amount), reason: advanceForm.reason || null, advance_date: advanceForm.advance_date, repayment_status: advanceForm.repayment_status, deduct_from_wages: advanceForm.deduct_from_wages, notes: advanceForm.notes || null });
  ...
  async function saveAttendance() {
    ...
    try {
      ...
      await supabase.from('attendance').insert({ employee_id: selectedEmployee.id, store_id: storeId || '05328298-fc27-4c9f-b091-bb7f6598b601', work_date: attendanceForm.work_date, clock_in: clockIn, clock_out: clockOut, hours_worked: hours, is_late: attendanceForm.is_late, notes: attendanceForm.notes || null });
