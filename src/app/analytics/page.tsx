...
export default function AnalyticsPage(){
  ...
  async function fetchAnalytics(start:string,end:string){
    ...
    // Food & Packaging Cost = opening stock (food+packaging) + all purchases - closing stock - wastage
    ...
    const pieSlices=[
      {label:'Food & Packaging Cost',value:foodCostAmount,color:'#ef4444'},
      ...
      {loading?<div style={{textAlign:'center',padding:80,color:'#9ca3af',fontSize:16}}>⏳ Calculating…</div>:!data?null:<>
        ...
        {view==='compare'&&compareData&&<div style={{...card,marginBottom:16}}>
          ...
          {[
            ...
            {label:'Food & Packaging Cost',curr:data.foodCostAmount,prev:compareData.foodCostAmount},
